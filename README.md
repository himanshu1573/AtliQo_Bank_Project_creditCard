...
![Phase 1 Completion](https://github.com/himanshu1573/AtliQo_Bank_Project_creditCard/blob/main/Phase_B/chapter11_assets/analysis.png)
...
![Phase 2 Completion](https://github.com/himanshu1573/AtliQo_Bank_Project_creditCard/blob/main/Phase_B/chapter11_assets/Screenshot%202024-12-08%20at%2011.10.15%E2%80%AFPM.png)
...
1. Clone this repository:
   ```bash
   git clone https://github.com/himanshu1573/AtliQo_Bank_Project_creditCard.git
   ```

2. Navigate to the project directory:
   ```bash
   cd AtliQo_Bank_Project_creditCard
   ```

3. Open the Jupyter notebooks in Phase_A and Phase_B directories to explore the analysis.

---

## **Project Structure**
```
AtliQo_Bank_Project_creditCard/
├── Phase_A/
│   ├── datasets/
│   ├── phase_1_atliqo_bank.ipynb
│   ├── phaseA_Credit_Score_2.ipynb
│   ├── phaseA_customers_1.ipynb
│   └── phaseA_Transaction_3.ipynb
└── Phase_B/
    └── chapter11_assets/
        ├── analysis.png
        ├── data/
...
## **Repository**
This project is available at: [https://github.com/himanshu1573/AtliQo_Bank_Project_creditCard.git](https://github.com/himanshu1573/AtliQo_Bank_Project_creditCard.git)
